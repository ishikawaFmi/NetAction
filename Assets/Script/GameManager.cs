...
public class GameManager : MonoBehaviour
{
    ...
    public Sprite ReturnCardSprite(Trump.Suit suit, int index) => _spriteList.ToList().Find(x => x.name == $"{suit}{index}");//�X�[�g�ƃC���f�b�N�X�ɉ������J�[�h�̃X�v���C�g��Ԃ�
    ...
    void NetWorkIncetanceCard(Trump trump)
    {
        if (trump != null)
        {
            ...
            NetWorkManager.Incetance.SendJsonMessege(new NetWorkManager.Messege("IncetanceCard", NetWorkManager.SendMesageState.MetHod, NetWorkManager.Incetance.PlayerId, cardJson));
    ...
    public void CardChaeck()
    {
        ...
        if (!isChaeck)
        {
            NetWorkManager.Incetance.SendJsonMessege(new NetWorkManager.Messege("NotCard", NetWorkManager.SendMesageState.MetHod, NetWorkManager.Incetance.PlayerId));
        }
    ...
    public void WinChack()
    {
        ...
        {
            Debug.Log("winChack");
            NetWorkManager.Incetance.SendJsonMessege(new NetWorkManager.Messege("WinChack", NetWorkManager.SendMesageState.MetHod, NetWorkManager.Incetance.PlayerId));
            WinCheak = true;
        }
